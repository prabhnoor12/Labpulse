...
const patientDataSchema = z.object({
  ...
  accessionNumber: text(64).optional(),
  ...
  specimenStatus: z.enum(['ORDERED', 'COLLECTED', 'RECEIVED', 'PROCESSING', 'REJECTED', 'RESULTS_PENDING', 'COMPLETE']).optional(),
  sampleRejectionReason: text(1_000).optional(),
  sampleCollectedBy: text(200).optional(),
  sampleReceivedBy: text(200).optional(),
...
const reportDataSchema = z.object({
  ...
  criticalResultStatus: z.enum(['NOT_APPLICABLE', 'PENDING', 'ACKNOWLEDGED']).optional().default('NOT_APPLICABLE'),
  criticalResultNotes: text(2_000).optional().default(''),
  criticalResultAcknowledgedBy: text(128).optional(),
  criticalResultAcknowledgedAt: text(80).optional(),
